...
const ItemConfigureModal = ({ item }) => {
  ...
  const selectedOption = useSelector((state) => {
    ...
    return state.app.selectedOption;
  });
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-center mb-4 p-5 md:p-0 sticky top-0 bg-white z-10">
            <div
              onClick={handleCloseModal} // closes modal when clicking outside(false))}
          ...
          <div className="flex flex-col relative md:flex-row gap-x-16 h-full">
            {/* Item image */}
            ...
            <div className="flex-[1.5]  px-5 scrollbar-hide md:overflow-y-auto max-h-[80vh]">
              ...
              <div className="mt-10">
                ...
                <div className="flex border-b border-gray-200 flex-col gap-y-4">
                  ...
                  >
                    ...
                    {selectedOption === "Fries" ? (
                      <div className="flex gap-x-3 items-center">
                        <div className="border-4 border-red-600 h-5 w-5 rounded-full"></div>
                        <img
                          className="h-5 w-5"
                          src={forwardIcon}
                          alt="forward-icon"
                  ...
                  >
                    ...
                    {selectedOption === "Extra pickle 0.5" ? (
                      <div className="flex gap-x-3 items-center">
                        <div className="border-4 border-red-600 h-5 w-5 rounded-full"></div>
                        <img
                          className="h-5 w-5"
              ...
              <div className="py-5 pb-40 md:pb-40">
              ...
              <div className="fixed left-0 right-0 bottom-0 md:absolute md:left-auto md:right-5 md:bottom-10  md:rounded-lg py-5 px-5 md:px-0 gap-x-23  bg-white flex justify-between items-center ">
