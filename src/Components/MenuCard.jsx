  ...
  return (
    <>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="bg-white p-6 rounded-lg max-w-[940px] w-full max-h-[90vh] overflow-hidden fixed top-[50px]"
          ...
          >
            ...
            <div className="flex justify-between items-center mb-4 sticky top-0 bg-white z-10">
              <div onClick={closeModal} className="cursor-pointer">
                <Button
                  className={"rounded-full hover:!bg-white !bg-background"}
                >
                  <img className="w-6 h-6" src={close} alt="" />
                </Button>
              </div>
              <div className="flex items-center gap-x-10">
                <img className="w-6 cursor-pointer h-6" src={fav} alt="" />
                <img className="w-6 cursor-pointer h-5" src={share} alt="" />
              </div>
            </div>
            <div className="flex gap-x-16 h-full">
              ...
              <div className="flex-[1.5] px-5 scrollbar-hide overflow-y-auto max-h-[80vh]">
                ...
                <div className="py-5">
                  ...
                  <Input className="border-2 my-5 min-h-30 border-gray-200 rounded-lg"></Input>
                </div>
