...
const MenuCard = ({ item }) => {
  return (
    <div className="w-full cursor-pointer relative gap-5 px-5 max-h-50 flex border border-gray-200 rounded-lg">
      ...
      <Button
        className={
          "absolute rounded-full !px-2  !py-2 bottom-5 border border-gray-200 right-5"
        }
      >
